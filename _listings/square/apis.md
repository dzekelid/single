...
created: "2018-08-26"
modified: "2018-08-26"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/single/master/_listings/square/apis.md
...
- name: Square Connect - Provides the details for a single item, including associated
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/single/master/_listings/square/v1location-iditemsitem-id-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/single/master/_listings/square/v1location-iditemsitem-id-get-openapi.md
x-common:
- type: x-website
  url: http://square.com
- type: x-api-gallery
